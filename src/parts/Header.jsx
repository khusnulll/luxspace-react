          ...
          <div className="w-auto">
            <ul className="fixed bg-white text-black inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center" id="menu">
              <li className="mx-3 py-6 md:py-0">
                <a className={["hover:underline cursor-pointer", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")} onClick={() => navigate("/showcase")}>
                  Showcase
                </a>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <a className={["hover:underline cursor-pointer", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")} onClick={() => navigate("/catalog")}>
                  Catalog
                </a>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <a className={["hover:underline cursor-pointer", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")} onClick={() => navigate("/delivery")}>
                  Delivery
                </a>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <a className={["hover:underline cursor-pointer", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")} onClick={() => navigate("/rewards")}>
                  Rewards
                </a>
              </li>
            </ul>
          ...
          <div className="w-auto">
            <ul className="items-center flex">
              <li className="ml-6 block md:hidden">
                <button id="menu-toggler" className="relative flex z-50 items-center justify-center w-8 h-8 sm:text-black md:text-white focus:outline-none">
              ...
              <li className="ml-6">
                <a className={["flex items-center justify-center w-8 h-8 ", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")} onClick={() => navigate("/cart")}>
