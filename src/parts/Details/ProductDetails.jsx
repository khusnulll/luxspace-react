            ...
            <div className="thumbnail">
              <div className="px-2">
                <div className="item selected" data-img="./images/content/showcase-1.front.jpg">
                  <img src="../.././public/assets/images/content/showcase-1.front.jpg" alt="front" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div className="px-2">
                <div className="item" data-img="./images/content/showcase-1.back.jpg">
                  <img src="../.././public/assets/images/content/showcase-1.back.jpg" alt="back" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div className="px-2">
                <div className="item" data-img="./images/content/showcase-1.rear.jpg">
                  <img src="../.././public/assets/images/content/showcase-1.rear.jpg" alt="rear" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div className="px-2">
                <div className="item" data-img="./images/content/showcase-1.side.jpg">
                  <img src="../.././public/assets/images/content/showcase-1.side.jpg" alt="side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div className="px-2">
                <div className="item" data-img="./images/content/showcase-1.top.jpg">
                  <img src="../.././public/assets/images/content/showcase-1.top.jpg" alt="top" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
            </div>
