...
function SitemapList({isActive, setActive, children, title}){
  return (
    <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
      <h5 className="text-lg font-semibold mb-2 relative">{title}
      <button onClick={() => setActive(isActive)} className={["absolute block md:hidden right-0 transform top-1/2 -translate-y-1/2 focus:outline-none transition duration-200", isActive ? "rotate-0" : "rotate-180"].join("")}><svg
                    width="20"
                    height="9"
                    viewBox="0 0 20 9"
                    fill="none"
      ...
      <div className="border-b border-gray-200 py-12 mt-16 px-4">
        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap -mx-4 justify-center">
            <SitemapList setActive={setActive} isActive={active === 1 ? null : 1} title="Overview">
            <li>
              <a onClick={() => navigate("/shipping")} className="hover:underline py-1 block">
                 Shipping
              </a>
           </li>
           <li>
              <a onClick={() => navigate("/refund")} className="hover:underline py-1 block">
                 Refund
              </a>
           </li>
           <li>
              <a onClick={() => navigate("/promotion")} className="hover:underline py-1 block">
                  Promotion
              </a>
            </li>
            </SitemapList>
            <SitemapList setActive={setActive} isActive={active === 2 ? null : 2} title="Company">
            <li>
                  <a onClick={() => navigate("/about")} className="hover:underline py-1 block">
                    About
                  </a>
                </li>
                <li>
                  <a onClick={() => navigate("/career")} className="hover:underline py-1 block">
                    Career
                  </a>
                </li>
                <li>
                  <a onClick={() => navigate("/contact")} className="hover:underline py-1 block">
                    Contact Us
                  </a>
                </li>
            </SitemapList>
            <SitemapList setActive={setActive} isActive={active === 3 ? null : 3} title="Explore">
            <li>
                  <a onClick={() => navigate("/terms&condition")} className="hover:underline py-1 block">
                    Terms & Conds
                  </a>
                </li>
                <li>
                  <a onClick={() => navigate("/privacypolicy")} className="hover:underline py-1 block">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a onClick={() => navigate("/fordeveloper")} className="hover:underline py-1 block">
                    For Developer
                  </a>
                </li>
            </SitemapList>
